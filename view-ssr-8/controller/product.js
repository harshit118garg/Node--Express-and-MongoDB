...
const productsFilePath = path.resolve(__dirname, "../pages/index.ejs");
const productsFormFilePath = path.resolve(__dirname, "../pages/addForm.ejs");
...
exports.getAllProductsSSR = async (req, res) => {
  try {
    ...
    console.log("server side rendering of products");
...
exports.createNewProductSSR = async (req, res) => {
  try {
    ejs.renderFile(productsFormFilePath, function (err, str) {
      res.send(str);
    });
  } catch (error) {
